          ...
          <div class="page-intro__item">
            <div class="info">
              ...
              <div class="info__content">
                <h4 class="info__label"><?php echo $label; ?></h4>
                <ul class="info__list">
                  <?php foreach ($links as $link) : ?>
                    ...
                    <li>
                      ...
                      <?php elseif ($type === 'phone') : ?>
                        <a href="tel:<?php echo clear_phone($text); ?>"><?php echo $text; ?></a>
                      <?php elseif ($type === 'email') : ?>
                        <a href="mailto:<?php echo $text; ?>"><?php echo $text; ?></a>
                      <?php else : ?>
                        <a href="#" class="info--dark"><?php echo $text; ?></a>
                      <?php endif; ?>
                    </li>
                  <?php endforeach; ?>
                </ul>

    ...
    <div class="single-case-studies__sidebar">
      ...
      <div class="case-share">
        ...
        <ul class="case-share__list">
          <li><a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo get_permalink(); ?>" target="_blank">
          ...
          <li><a href="https://twitter.com/intent/tweet?url=<?php echo get_permalink(); ?>" target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
